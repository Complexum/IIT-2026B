...
if TYPE_CHECKING:
    # pyttsx3 arrastra pyobjc (macOS) y su init es lento (~4.4s); se importa
    # de forma diferida sólo cuando realmente se sintetiza voz.
    from pyttsx3.engine import Engine
    from pyttsx3.voice import Voice

from src.iit.strategies.consts import PYPHI_LABEL
from src.iit.base.consts import FLOAT_ZERO, INT_ZERO, WHITESPACE
...
class Solution:
    ...
    ----
        ...
        hablar (bool, opcional):
            ...
            Por defecto es False (pyttsx3.init() es lento, ~4.4s).
