import sys
from src.iit.base.enums.distance import MetricDistance
from src.iit.base.enums.emd import TimeEMD
from src.iit.base.enums.notation import Notation
from src.iit.base.consts import ABC_START, ACTIVE, INACTIVE
...
class Application:
    ...
    def __init__(self) -> None:
        ...
        self.distancia_metrica: str = MetricDistance.HAMMING
        self.indexado_llegada: str = Notation.LIL_ENDIAN
        self.notacion_indexado: str = Notation.LIL_ENDIAN
        self.tiempo_emd: str = TimeEMD.EMD_EFECTO
        self.modo_estados: bool = ACTIVE
        self.profiler_habilitado: bool = True
        self.op_system = OS_OPTIONS.get(sys.platform, "win32")
